...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../deployment-handson-2',
    '/home/ubuntu/deployment-handson-2',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf deployment-handson-2-temp && mkdir deployment-handson-2-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r deployment-handson-2-temp/* deployment-handson-2/ && rm -rf deployment-handson-2-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd deployment-handson-2 && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `deployment-handson-2-temp` folder.');
